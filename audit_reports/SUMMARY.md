# Data Integrity Audit · 2026-04-28

**Overall:** 🔴 `critical`  ·  critical gaps: **1**  ·  warn gaps: 79
...
|---|---|---|---|---|---|---|
| race_artefacts | 🟡 warn | 605 | 600 | 5 | 0 | days with any missing artefact: 1 |
| fixtures_cache | 🟢 ok | 1 | 143 | 0 | 0 | total cached race days: 143 |
| horse_profiles | 🟢 ok | 1282 | 1282 | 0 | 0 | total profiles in DB: 5933 |
| horse_form_records | 🟢 ok | 1282 | 1282 | 0 | 0 | total form_records files: 5933 |
...
| trial_results | 🟢 ok | 1 | 1 | 0 | 0 | trial rows: 5699 |
